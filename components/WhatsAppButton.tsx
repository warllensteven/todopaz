// ─── BOTÓN DE WHATSAPP (CONVERSIÓN) ─────────────────────────────
// Este es el componente MÁS importante de todo tu SaaS.
// 👉 Aquí ocurre la conversión real (usuario → cliente del negocio)

'use client'
// Necesario porque hay lógica dinámica (props, interacción, encoding)


// ─── TIPADO ──────────────────────────────────────────────────────
type Props = {
  phone: string
  // Número del negocio (ej: 573001234567)
...
export default function WhatsAppButton({ phone, message }: Props) {
  ...
  // Si no hay teléfono → no renderiza nada
  // Evita botones rotos
  ...
  // encodeURIComponent → convierte el mensaje a formato válido para URL
  // Ej: espacios → %20
  ...
  return (
    <a
      ...
      // Abre chat directo con mensaje prellenado
